...
Balances should be verified daily using at least three ASTM Class 1, 2, or 3 non-reference weights. For balances used for microbioligical drinking water analysis, a sensitivity check should be performed by adding a 0.1g weight to the upper check point. Non-reference weights should be validated at least every 6 months with reference weights. Correction values should be on file and used. A reference weight should be recertified at least every 5 years. Damaged or corroded weights should be replaced.
...
Each time the autoclave is used, the date, contents, sterilization time and temperature, total time in the autoclave, and analyst's initials should be recorded. Service contract work and maintenance records shall be maintained.

A maximum-temperature-registering thermometer, electronic temperature readout device, or continuous recording device shoulbe used during each autoclave cycle to ensure that the proper termperature was reached, and the temperature recorded. Overcrowding should be avoided. Spore strips or spore ampules should be used at least monthly as bioindicators to confirm sterilization. Note that chemical indicators (e.g., autoclave tape) will respond to a wide range of times and temperatures (longer time lower temperature or shorter time higher temperature). Therefore, chemical indicators should not be used to show that sterilization has occurred.

Automatic timing mechanisms should be checked quarterly with a stopwatch or other accurate timepiece and the results recorded in the equipment history log.

Door seals should be clean and free of carmelized media. Autoclave drain screens should be cleaned frequently and debris removed.
### Pipets
